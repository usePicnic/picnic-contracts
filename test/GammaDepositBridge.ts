...
describe("GammaDepositBridge", function () {
    ...
    describe("Actions", function () {      
        it("Deposit and withdraw WMATIC/USDC", async function () {
            ...
            let tokenB = TOKENS['USDC'];
            let tokenA = TOKENS['WMAIN'];
            let poolAddress = '0x4A83253e88e77E8d518638974530d0cBbbF3b675';
